...
const outcomes = updateRecords(database, [
  { table: "Customer", recordId: "CUST-0001", values: { headcount: "12" } },
  { table: "Customer", recordId: "CUST-0002", values: { headcount: "many" } },
]);

for (const outcome of outcomes) {
  if (outcome.accepted) {
    console.log(outcome.recordId, outcome.values); // CUST-0001 { headcount: 12 }
  } else {
    console.log(outcome.recordId, outcome.code); // CUST-0002 DB_INVALID_NUMBER
  }
}
```
