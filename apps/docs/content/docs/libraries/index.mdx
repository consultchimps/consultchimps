...
provenance. Invalid prepared rows return `DB_INVALID_PREPARED_IMPORT`; invalid
reused database captures return `DB_CORRUPT_DATABASE`. Other adapters can supply
