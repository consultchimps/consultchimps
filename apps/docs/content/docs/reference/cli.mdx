...
Required:
  --template-slide <number>  one-based template slide number
```

The report lists valid placeholder names and occurrence counts, malformed
placeholder locations, unsupported placements, and placeholders split across
PowerPoint text runs.
...
Required:
  ...
  --sheet <name>             worksheet containing the records
  --template-slide <number>  one-based template slide number
