...
| `-sALLOW_MEMORY_GROWTH=1`                                                        | The corpus peaks at 33,554,432 bytes of linear memory on the largest fixture, and a fixed heap would have to be sized for that on every model.                                                                                                                                                           |
