...
#define ALIGNAS_1024 __declspec(align(1024))
#else  // GCC, Clang, and others
#define ALIGNAS_64 __attribute__((aligned(64)))
#define ALIGNAS_1024 __attribute__((aligned(1024)))
#endif
...
ALIGNAS_64 static
UInt8 s_uHuffmanBitReverseTable[64] =
{
    /*   0 */   0,
    /*   1 */  32,
    /*   2 */  16,
...
)
{
    ...
    ASSERT (uMask < (((uxint) 1) << uBits), "uMask=0x%Ix uBits=%u", uMask, uBits);
