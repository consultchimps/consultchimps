...
#define XPRESS9_USE_SSE2    0//(defined(_M_IX86) || defined(_M_AMD64) || defined(_M_IA64) || defined(__x86_64__) || defined(__ia64__)
#endif /* XPRESS9_USE_SSE2 */

#ifndef XPRESS9_USE_SSE4
#define XPRESS9_USE_SSE4   0// (defined(_M_IX86) || defined(_M_AMD64) || defined(_M_IA64) || defined(__x86_64__) || defined(__ia64__)
...
#define XPRESS9_HAVE_BARREL_SHIFTER 0//(defined(_M_IX86) || defined(_M_AMD64) || defined(_M_IA64) || defined(__x86_64__) || defined(__ia64__)
...
#include <stdio.h>
#pragma warning (pop)
#define DEBUG_PERF_START(timer)     ((timer) -= __builtin_ia32_rdtsc ())
#define DEBUG_PERF_STOP(timer)      ((timer) += __builtin_ia32_rdtsc ())
#else
...
//
typedef UInt64 uxint;
typedef Int64   xint;
//TODO: check commented conditions
// #if defined(_M_AMD64) || defined(_M_IA64) || defined(__x86_64__) || defined(__ia64__)  || defined(__wasm_32__)
...
//TODO: review DEBUG_PRINT macro
// #define DEBUG_PRINT(pFormat, ...) printf(pFormat)
#define DEBUG_PRINT(pFormat, ...)
// #define DEBUG_PRINT(pFormat,...) (printf (pFormat "\n", __VA_ARGS__))
...
#define SET_ERROR(uErrorCode, pStatus, pFormat, ...) do {                  \
    pStatus->m_uStatus = uErrorCode;                                       \
    snprintf(pStatus->m_ErrorDescription, sizeof(pStatus->m_ErrorDescription), \
             pFormat, ##__VA_ARGS__);                                      \
} while (0)
#endif
...
//
//TODO: check if this is correct for 64-bit platforms
// #if defined (_M_AMD64) || defined (_M_IA64) || defined(__x86_64__) || defined(__ia64__)  || defined(__wasm_32__)
...
/*                                            ---------------                                     */
//#ifdef _MSC_VER
//    // Use the Microsoft-specific intrinsic on Microsoft platforms.
//#include <intrin.h>
//#pragma intrinsic(_BitScanReverse)
//#else
//    // Define a macro to emulate _BitScanReverse using __builtin_clz.
//#define _BitScanReverse(pIndex, mask) \
//        (*(pIndex) = (mask) ? (31 - __builtin_clz(mask)) : 0)
//#endif
#ifdef __GNUC__  // If using GCC or Clang
#include <stdint.h>
...
#define XPRESS9_ENCODER_MAGIC 0x65787039
...
#define XPRESS9_DECODER_MAGIC 0x64397870
