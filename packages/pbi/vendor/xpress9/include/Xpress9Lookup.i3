...
//
// This is identical to xpress9lookup.i2, except that the labels start with L3_ so we can include this file a third time.
// Also, _uMaxDepth is set to equal uMaxDepth3 instead of uMaxDepth
//
